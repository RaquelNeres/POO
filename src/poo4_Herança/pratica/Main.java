...
public class Main {
    static void main(String[] args) {
        ...
        Data dataHoje = new Data(10, 9, 2025);
        Data dataCriacao1 = new Data(1, 1, 2023);
        Data dataCriacao2 = new Data(15, 6, 2024);
        ...
        Gerente gerente1 = new Gerente("Carlos Mendes", new Data(10, 12, 1980), 'M', "111.222.333-44", "G001", "senha123");
        Gerente gerente2 = new Gerente("Ana Costa", new Data(5, 8, 1975), 'F', "555.666.777-88", "G002", "minhasenha");
        ...
        ContaCorrente cc1 = new ContaCorrente("CC001", pessoa1, gerente1, dataCriacao1);
        ContaCorrente cc2 = new ContaCorrente("CC002", pessoa2, gerente2, dataCriacao2);
        ...
        Poupanca poup1 = new Poupanca("P001", pessoa1, gerente1, dataCriacao1);
        Poupanca poup2 = new Poupanca("P002", pessoa2, gerente2, dataCriacao2);
